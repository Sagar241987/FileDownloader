...
- (void)viewDidLoad {
    ...
    NSDictionary *parameters;
        ...
        parameters = @{
                       ...
                       CAPSPageMenuOptionScrollMenuBackgroundColor:[UIColor whiteColor], CAPSPageMenuOptionSelectionIndicatorColor: [UIColor colorWithRed:5.0/255.0f green:102.0/255.0f blue:159.0/255.0f alpha:1.0],
    ...
    _pageMenu = [[CAPSPageMenu alloc] initWithViewControllers:controllerArray frame:CGRectMake(0, 72.0, self.view.frame.size.width, [UIScreen mainScreen].bounds.size.height - 100) options:parameters withType:NO];
